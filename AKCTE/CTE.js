	...
	if(el.getAttribute("data-open") == 0){
		...
		switch(e){
			...
			case 3:
				...
				document.getElementById("TeachImg").src = "/AKCTE/Teacher/robinson.jpg";
				break;
			case 4:
				...
				document.getElementById("TeachImg").src = "/AKCTE/Teacher/hicks.jpg";
				break;
			case 5:
				...
				document.getElementById("TeachImg").src = "/AKCTE/Teacher/shaffer.jpg";
				break;
		}
